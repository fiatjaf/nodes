(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({"/home/fiatjaf/comp/go/src/nodes/embed/iframe.coffee":[function(require,module,exports){
var called, crosstab, url;
...
window.addEventListener('message', function(e) {
  ...
  if (e.data.kind === 'here') {
    return url = e.data.url;
  }
}, false);

crosstab.on('message', function(e) {
...
window.onunload = window.onbeforeunload = function() {
  if (called) {
    ...
    called = true;
    return crosstab.broadcast('message', {
      kind: 'nothere',
      url: url
    });
  }
...
},{"crosstab":"/home/fiatjaf/comp/go/src/nodes/node_modules/crosstab/src/crosstab.js"}],"/home/fiatjaf/comp/go/src/nodes/node_modules/crosstab/src/crosstab.js":[function(require,module,exports){
(function (global){
/*!
...
},{}]},{},["/home/fiatjaf/comp/go/src/nodes/embed/iframe.coffee"]);
